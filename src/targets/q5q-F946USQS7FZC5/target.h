 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "q5q-F946USQS7FZC5-app"
#define PHYS_P0_ORACLE 1
#define SLIDE_ROUTE SLIDE_ROUTE_MCAST

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/q5qsqw/q5q:16/BP2A.250605.031.A3/F946USQS7FZC5:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/q5q-F946USQS7FZC5/p0_fingerprint.h"
 ...
 * ------------------------------------------------------------------------- */
/* --- global / root symbols ------------------------------------------------ */
#define INIT_TASK_OFF             0x02afa880ULL
...
#define KMALLOC_CACHES_OFF        0x01f9e058ULL
#define ANON_PIPE_BUF_OPS_OFF     0x01dc87e0ULL
...
#define ASHMEM_FOPS_OFF           0x01f474a0ULL
#define ASHMEM_MISC_FOPS_OFF      0x02af27e8ULL
#define ASHMEM_IOCTL_OFF          0x010c0ac8ULL
#define ASHMEM_COMPAT_IOCTL_OFF   0x010c1124ULL
#define ASHMEM_MMAP_OFF           0x010c117cULL
#define ASHMEM_OPEN_OFF           0x010c145cULL
#define ASHMEM_RELEASE_OFF        0x010c14f4ULL
#define ASHMEM_SHOW_FDINFO_OFF    0x010c1610ULL
...
/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01cbb46bULL
